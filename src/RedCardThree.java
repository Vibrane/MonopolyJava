...
public class RedCardThree extends PropertyCard {

    private DrawingCanvas canvas;
    private FramedRect propertyRect;
    private String propertyName = "Red Card Three";
    private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
    private int value = 240;

    public RedCardThree(DrawingCanvas boardCanvas) {
        this.canvas = boardCanvas;
        this.propertyRect = new FramedRect((canvas.getWidth() * 4) / 11 + 5, 0 + 5, this.canvas.getWidth() / 11 - 5, this.canvas.getHeight() / 11 - 5, canvas);
        ...
        this.cardColor.setColor(Color.RED);
    ...
    public void run() {
        ...
        while (true) {            
                ...
                this.propertyRect.moveTo((canvas.getWidth() * 4) / 11 + 5, 0 + 5);
