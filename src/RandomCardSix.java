...
public class RandomCardSix extends PropertyCard {
	...
	public RandomCardSix(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 6 / 11 + 5,
	...
	public void run() {
		...
		while (true) {
			...
			this.propertyRect.moveTo((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 6 / 11 + 5);
