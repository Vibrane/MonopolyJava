...
public class BlueThree extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Blue Three";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 120;

	public BlueThree(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(canvas.getWidth() / 11 + 5, canvas.getHeight() *
	// 10 / 11 + 5);
