...
public class GovernmentOne extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Utility Two";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 150;

	public GovernmentOne(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect((canvas.getWidth() * 8) / 11 + 5, 0 + 5, this.canvas.getWidth() / 11 - 5,
	...
	// while (true) {
	//
	// this.propertyRect.moveTo((canvas.getWidth() * 8) / 11 + 5, 0 + 5);
