...
public class RandomCardThree extends PropertyCard {
	...
	public RandomCardThree(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 3 / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
	...
	public void run() {
		...
		while (true) {
			...
			this.propertyRect.moveTo(canvas.getWidth() * 3 / 11 + 5, canvas.getHeight() * 10 / 11 + 5);
