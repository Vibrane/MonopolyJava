...
public class RailRoadOne extends PropertyCard {

    private DrawingCanvas canvas;
    private FramedRect propertyRect;
    private String propertyName = "Rail Road";
    private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
    private int value = 200;

    public RailRoadOne(DrawingCanvas boardCanvas) {
        this.canvas = boardCanvas;
        this.propertyRect = new FramedRect((canvas.getWidth() * 5) / 11 + 5, 0 + 5, this.canvas.getWidth() / 11 - 5, this.canvas.getHeight() / 11 - 5, canvas);
    ...
    public void run() {
        ...
        while (true) {            
                ...
                this.propertyRect.moveTo((canvas.getWidth() * 5) / 11 + 5, 0 + 5);
