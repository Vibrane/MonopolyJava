...
public class RailRoadTwo extends PropertyCard {
	...
	public RailRoadTwo(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(0 + 5, canvas.getHeight() * 5 / 11 + 5, this.canvas.getWidth() / 11 - 5,
	...
	public void run() {
		...
		while (true) {
		     ...
		     this.propertyRect.moveTo(0 + 5, canvas.getHeight() * 5 / 11 + 5);
