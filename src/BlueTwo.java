...
public class BlueTwo extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Blue Two";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 100;

	public BlueTwo(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 2 / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
		...
		this.cardColor.setColor(Color.CYAN);
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(canvas.getWidth() * 2 / 11 + 5,
