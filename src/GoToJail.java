...
public class GoToJail extends PropertyCard {

    private DrawingCanvas canvas;
    private FramedRect propertyRect;
    private String propertyName = "Go to Jail";
    private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
    private int value = 500;

    public GoToJail(DrawingCanvas boardCanvas) {
        this.canvas = boardCanvas;
        this.propertyRect = new FramedRect((canvas.getWidth() * 10) / 11 + 5, 0 + 5, this.canvas.getWidth() / 11 - 5, this.canvas.getHeight() / 11 - 5, canvas);
        ...
        this.cardColor.setColor(Color.BLACK);
...
//        while (true) {            
//                
//                this.propertyRect.moveTo((canvas.getWidth() * 10) / 11 + 5, 0 + 5);
