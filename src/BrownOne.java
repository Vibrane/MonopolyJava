...
public class BrownOne extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Brown One";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 60;

	public BrownOne(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 9 / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
		...
		this.cardColor.setColor(Color.LIGHT_GRAY);
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(canvas.getWidth() * 9 / 11 + 5,
