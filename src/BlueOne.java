...
public class BlueOne extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Blue One";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 100;

	public BlueOne(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 4 / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(canvas.getWidth() * 4 / 11 + 5,
