...
public class PlayerThree extends Player {
	...
	public PlayerThree(DrawingCanvas canvas) {
		this.canvas = canvas;

		this.propertyRect = new FilledRect(this.canvas.getWidth() / 11 + 5, this.canvas.getHeight() * 3 / 11 + 5,
		...
		this.playerInfoText.setColor(Color.YELLOW);
		this.moneyPouch.setColor(Color.YELLOW);
		this.currentLocation.setColor(Color.YELLOW);
