...
public class BrownTwo extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Brown Two";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 60;

	public BrownTwo(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 7 / 11 + 5, canvas.getHeight() * 10 / 11 + 5, this.canvas.getWidth() / 11 - 5,
		...
		this.cardColor.setColor(Color.lightGray);
...
//		while (true) {
//
//		     this.propertyRect.moveTo(canvas.getWidth() * 7 / 11 + 5, canvas.getHeight() * 10 / 11 + 5);
