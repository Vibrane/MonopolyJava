...
public class OrangeTwo extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Orange Two";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 180;

	public OrangeTwo(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(0 + 5, canvas.getHeight() * 2 / 11 + 5, this.canvas.getWidth() / 11 - 5,
...
//		while (true) {
//
//		     this.propertyRect.moveTo(0 + 5, canvas.getHeight() * 2 / 11 + 5);
