...
public class GovernmentTwo extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Utility One";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 150;

	public GovernmentTwo(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(0 + 5, canvas.getHeight() * 8 / 11 + 5, this.canvas.getWidth() / 11 - 5,
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(0 + 5, canvas.getHeight() * 8 / 11 + 5);
