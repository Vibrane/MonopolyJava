...
public class PinkThree extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Pink Three";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 140;

	public PinkThree(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(0 + 5, canvas.getHeight() * 6 / 11 + 5, this.canvas.getWidth() / 11 - 5,
		...
		this.cardColor.setColor(Color.PINK);
...
//		while (true) {
//
//		     this.propertyRect.moveTo(0 + 5, canvas.getHeight() * 6 / 11 + 5);
