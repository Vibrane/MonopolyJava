...
public class RandomCardFour extends PropertyCard {
	...
	public RandomCardFour(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 8 / 11 + 5, canvas.getHeight() * 10 / 11 + 5, this.canvas.getWidth() / 11 - 5,
	...
	public void run() {
		...
		while (true) {
		     ...
		     this.propertyRect.moveTo(canvas.getWidth() * 8 / 11 + 5, canvas.getHeight() * 10 / 11 + 5);
