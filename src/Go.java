...
public class Go extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Go";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 200;

	public Go(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 10 / 11 + 5, canvas.getHeight() * 10 / 11 + 5,
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(canvas.getWidth() * 10 / 11 + 5,
	// canvas.getHeight() * 10 / 11 + 5);
	// this.propertyRect.setSize(this.canvas.getWidth() / 11 - 5,
	// this.canvas.getHeight() / 11 - 5);
	// this.cardColor.setSize(this.propertyRect.getWidth(),
	// this.propertyRect.getHeight() / 3);
	// this.cardColor.moveTo(this.propertyRect.getLocation());
	// this.p1.moveTo(this.cardColor.getX(), this.cardColor.getY() +
	// this.cardColor.getHeight());
	// this.p1.setSize(this.propertyRect.getWidth() / 4,
	// this.propertyRect.getHeight() / 3);
	// this.p2.moveTo(this.p1.getX() + this.p1.getWidth(), this.cardColor.getY()
	// + this.cardColor.getHeight());
	// this.p2.setSize(this.propertyRect.getWidth() / 4,
	// this.propertyRect.getHeight() / 3);
	// this.p3.moveTo(this.p2.getX() + this.p2.getWidth(), this.cardColor.getY()
	// + this.cardColor.getHeight());
	// this.p3.setSize(this.propertyRect.getWidth() / 4,
	// this.propertyRect.getHeight() / 3);
	// this.p4.moveTo(this.p3.getX() + this.p3.getWidth(), this.cardColor.getY()
	// + this.cardColor.getHeight());
	// this.p4.setSize(this.propertyRect.getWidth() / 4,
	// this.propertyRect.getHeight() / 3);
	// this.ownedBy.moveTo(this.propertyRect.getX(), this.p4.getY() +
	// this.p4.getHeight());
	// this.ownedBy.setSize(this.propertyRect.getWidth(),
	// this.propertyRect.getHeight() / 3);
	//
	// }
	// }
