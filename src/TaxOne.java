...
public class TaxOne extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Tax One";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 400;

	public TaxOne(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(canvas.getWidth() * 6 / 11 + 5, canvas.getHeight() * 10 / 11 + 5, this.canvas.getWidth() / 11 - 5,
