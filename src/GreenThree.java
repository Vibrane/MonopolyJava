...
public class GreenThree extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Green Three";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 320;

	public GreenThree(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 4 / 11 + 5,
...
//		while (true) {
//
//			this.propertyRect.moveTo((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 4 / 11  + 5);
