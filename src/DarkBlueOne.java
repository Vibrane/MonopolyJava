...
public class DarkBlueOne extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Dark Blue One";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 350;

	public DarkBlueOne(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 7 / 11 + 5,
		...
		this.cardColor.setColor(Color.BLUE);
...
//		while (true) {
//
//			this.propertyRect.moveTo((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 7 / 11  + 5);
