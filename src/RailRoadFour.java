...
public class RailRoadFour extends PropertyCard {
	...
	public RailRoadFour(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect((canvas.getWidth() * 10) / 11 + 5, canvas.getHeight() * 5 / 11 + 5,
