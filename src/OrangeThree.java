...
public class OrangeThree extends PropertyCard {

	private DrawingCanvas canvas;
	private FramedRect propertyRect;
	private String propertyName = "Orange Three";
	private FilledRect cardColor, p1, p2, p3, p4, ownedBy;
	private int value = 200;

	public OrangeThree(DrawingCanvas boardCanvas) {
		this.canvas = boardCanvas;
		this.propertyRect = new FramedRect(0 + 5, canvas.getHeight() / 11 + 5, this.canvas.getWidth() / 11 - 5,
		...
		this.cardColor.setColor(Color.ORANGE);
	...
	// while (true) {
	//
	// this.propertyRect.moveTo(0 + 5, canvas.getHeight() / 11 + 5);
